...
public class Common {
    ...
    public static final String CUSTOM_PAPER_FOLDER =
        Environment.getExternalStorageDirectory().toString() + "/customPaperFileSet/";
    ...
    public static boolean isImageFile(final String path) {
        ...
        if ((extention.equalsIgnoreCase("jpg")) || (extention.equalsIgnoreCase("jpeg"))
            || (extention.equalsIgnoreCase("bmp")) || (extention.equalsIgnoreCase("png"))
