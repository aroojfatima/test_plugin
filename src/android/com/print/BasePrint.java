...
public abstract class BasePrint {
    ...
    protected SharedPreferences sharedPreferences, pref;
    ...
    public void setPrinterInfo() {
      ...
      /*  mPrinterInfo = mPrinter.getPrinterInfo();
        ...
        mPrinterInfo.ipAddress = "192.168.1.8"; */
        /********************************/
    ...
    private void setPreferences() {    	
    	/*mPrinterInfo = mPrinter.getPrinterInfo();
        if (!sharedPreferences.getString("printerModel", "").equals(PrinterInfo.Model.QL_720NW)) {
        	 SharedPreferences.Editor editor = sharedPreferences.edit();
             editor.putString("printerModel", mPrinterInfo.printerModel.toString());
             editor.putString("port", mPrinterInfo.port.toString());
             editor.putString("address", mPrinterInfo.ipAddress.toString());
             editor.putString("macAddress", mPrinterInfo.macAddress.toString());
        }
        */
